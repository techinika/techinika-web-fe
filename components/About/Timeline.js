        ...
        <div className="flex flex-col md:grid grid-cols-9 mx-auto p-2 text-blue-50 w-11/12 md:w-10/12 m-auto">
          <div className="flex flex-row-reverse md:contents">
            <div className="bg-mainBlue col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md">
              ...
              <p className="text-justify text-white leading-loose">
                Cishahayo Songa Achille started a blog to help Rwandans
                understand how technology works and how they can use it to
                improve their lives.
              </p>
            </div>
          ...
          <div className="flex md:contents">
            ...
            <div className="bg-mainBlue col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md">
              ...
              <p className="text-justify text-white leading-loose">
                Kabalira Lucette Sarah joined the team in the journey to make
                the best and strong contents to the audience that was growing
                day by day.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-row-reverse md:contents">
            <div className="bg-mainBlue col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md">
              ...
              <p className="text-justify text-white leading-loose">
                We decided to transform our blog into the company and expand
                what we were doing. By doing that, we changed our name fron
                NIGUTE to Techinika. This name combines two names Technology and
                Gutekinika which means trying or exploring technology.
              </p>
            </div>
            <div className="col-start-5 col-end-6 md:mx-auto relative mr-10">
              <div className="h-full w-6 flex items-center justify-center">
          ...
          <div className="flex flex-row-reverse md:contents">
            <div className="bg-mainBlue col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md">
              ...
              <p className="text-justify text-white leading-loose">
                We had been working to bring technology to the masses in Rwanda
                and today, we have many programs to help us in doing that and we
                are getting piring results.
              </p>
            </div>
            <div className="col-start-5 col-end-6 md:mx-auto relative mr-10">
              <div className="h-full w-6 flex items-center justify-center">
