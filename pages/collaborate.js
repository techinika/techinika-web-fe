      ...
      <div>
        ...
        <div className="md:w-10/12 xs:w-full mx-auto text-white p-8">
          <div className="flex flex-wrap justify-center items-start mx-auto mt-8 md:w-11/12 gap-4">
            <div className="card">
              <h2 className="card-title">Sponsor our Community events</h2>
              <p className="card-body">
                {
                  "We organize events to educate our community on what is happening in tech, what is new, and how it affects them. Be a part of what we are doing by:"
                }
              </p>
              <ul className="list">
                <li className="list-item">Offering a venue</li>
                <li>Monetary Support</li>
                <li>Volunteer to support</li>
              </ul>
