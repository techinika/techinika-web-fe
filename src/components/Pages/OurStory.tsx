      ...
      <div className="bg-white font-main mx-auto mt-24">
        ...
        <div className="md:w-[60%] lg:w-[60%] sm:w-[90%] mx-auto text-xl py-4 text-justify p-2">
          ...
          <p>
            ...
            <b>
              *we are constantly running towards building people who use digital
              tools, and build digital tools to solve problems,*
            </b>{" "}
          ...
          <ul className="list list-decimal">
            ...
            <li className="items-center gap-2 list-item">
              <a
                ...
                className="text-main-blue hover:text-main underline"
              >
                Le Rwandais Cishahayo Songa Achille fournit aux particuliers et
                aux entreprises des compétences numériques modernes
              </a>
            </li>
          </ul>
          <br></br>
          ...
          <br></br>
          <p>
            We are thankful to you, our partners, our clients, and advisors who
            helped us get where we are today. Our work is building hundreds of
            generations to come, and we welcome new ideas and feedback from you!
